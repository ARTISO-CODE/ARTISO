    ...
    <div className="heritage-page">
      ...
      <section className="heritage-intro">
        <div className="heritage-intro-content">
          <div className="intro-text">
            ...
            <p>For centuries, Moroccan artisans have preserved their craft, passing down techniques and secrets from generation to generation. Each piece in our collection carries this rich heritage, telling stories of culture, tradition, and artistry.</p>
          </div>
          <div className="heritage-stats">
            ...
            <div className="stat">
              ...
              <span className="label">Master Artisans</span>
            </div>
            <div className="stat">
              <span className="number">12</span>
              <span className="label">Craft Traditions</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="craft-traditions">
        ...
        <div className="section-footer">
          ...
          >
            {showAllTraditions ? 'Show Less' : 'View All Traditions'}
          </button>
        </div>
      </section>
      ...
      <section className="heritage-quote">
        <div className="quote-content">
          <blockquote>
            "In every thread we weave, every pattern we paint, and every piece we craft, lies the soul of Morocco - a testament to our ancestors and a gift to future generations."
          </blockquote>
          <cite>- Master Artisan Hassan El Glaoui</cite>
        </div>
      </section>

      <section className="craft-regions">
        <h2>Regions of Excellence</h2>
